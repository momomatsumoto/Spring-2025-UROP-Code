...
E(g)$color <- ifelse(E(g)$relationship == "positive", "lightgreen", "red")
...
# Assign edge weights
E(g)$width <- E(g)$weight * 5 # Scale edge thickness for visibility
...
plot(g2,
     ...
     edge.arrow.size = 1.5,
     edge.curved = 0.3,
     main = "Directed Unweighted Network of Plant Co-occurrence")
